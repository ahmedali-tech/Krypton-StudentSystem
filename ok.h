...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ok::typeid));
			...
			this->label3->Location = System::Drawing::Point(669, 73);
			...
			this->button6->Location = System::Drawing::Point(582, 374);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(178, 69);
			this->button6->TabIndex = 35;
			this->button6->Text = L"BSCS-9";
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &ok::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button5->Location = System::Drawing::Point(908, 374);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(169, 67);
			this->button5->TabIndex = 34;
			this->button5->Text = L"BSCS-8";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &ok::button5_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(907, 222);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(166, 69);
			this->button3->TabIndex = 33;
			this->button3->Text = L"BSCS-11";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &ok::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(585, 222);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(175, 71);
			this->button2->TabIndex = 32;
			this->button2->Text = L"BSCS-10";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &ok::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &ok::button1_Click);
			// 
			// ok
			// 
			...
			this->Name = L"ok";
			this->Text = L"-";
			this->Load += gcnew System::EventHandler(this, &ok::ok_Load);
...
private: System::Void ok_Load(System::Object^ sender, System::EventArgs^ e) {
