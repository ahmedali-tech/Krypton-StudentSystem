...
namespace GUI {
	...
	/// <summary>
	/// Summary for Attendence
	/// </summary>
	public ref class Attendence : public System::Windows::Forms::Form
	{
	public:
		Attendence(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Attendence::typeid));
			...
			this->label1->Size = System::Drawing::Size(245, 72);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Attendence";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(411, 190);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(178, 29);
			this->label2->TabIndex = 4;
			this->label2->Text = L"Student name:";
			this->label2->Click += gcnew System::EventHandler(this, &Attendence::label2_Click);
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(834, 190);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(130, 29);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Ahmed Ali";
			// 
			// label4
			// 
			...
			this->label4->Location = System::Drawing::Point(411, 279);
			...
			this->label5->Location = System::Drawing::Point(834, 279);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(171, 29);
			this->label5->TabIndex = 7;
			this->label5->Text = L"Data structure";
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->BackColor = System::Drawing::Color::Transparent;
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->label6->Location = System::Drawing::Point(411, 370);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(149, 29);
			this->label6->TabIndex = 8;
			this->label6->Text = L"Percentage:";
			// 
			// label7
			// 
			...
			this->label7->Location = System::Drawing::Point(834, 370);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->label8->Location = System::Drawing::Point(411, 454);
			...
			this->label9->Location = System::Drawing::Point(834, 464);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(97, 29);
			this->label9->TabIndex = 11;
			this->label9->Text = L"341789";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(12, 506);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(178, 69);
			this->button1->TabIndex = 43;
			this->button1->Text = L"Back to Home";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Attendence::button1_Click);
			// 
			// Attendence
			// 
			...
			this->ClientSize = System::Drawing::Size(1060, 587);
			...
			this->Name = L"Attendence";
			this->Text = L"Attendence";
